 ...
 * @author Valter
 */
public class ViewLoginAsCustomer extends JFrame {
   // Text fields must be class members so all methods can access them
    ...
    public ViewLoginAsCustomer (Controller controller){
    ...
    private void attributesSetter(){
        ...
        this.setTitle("Logged in as Custumer");
    }
    ...
    private void components(){
        ...
        login.setActionCommand("loginCustomer");
